 ...
 *       &lt;sequence&gt;
 *         &lt;element name="firewallRule" type="{urn:didata.com:api:cloud:types}FirewallRuleType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class FirewallRules {
    ...
    public List<FirewallRuleType> getFirewallRule() {
        if (firewallRule == null) {
            firewallRule = new ArrayList<FirewallRuleType>();
        }
