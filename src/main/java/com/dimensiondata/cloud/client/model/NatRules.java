 ...
 *       &lt;sequence&gt;
 *         &lt;element name="natRule" type="{urn:didata.com:api:cloud:types}NatRuleType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class NatRules {
    ...
    /**
     * Gets the value of the natRule property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the natRule property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNatRule().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<NatRuleType> getNatRule() {
        if (natRule == null) {
            natRule = new ArrayList<NatRuleType>();
        }
        return this.natRule;
    }
